...
public class MainActivity extends AppCompatActivity {
    ...
    //TODO 1. Declare the shared preferences
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO 6. You will need to retrieve the sharedpreferences file
        mPreferences = getSharedPreferences(sharedPrefFile, MODE_PRIVATE);
        //TODO 7. You will need to get the key
    ...
    //TODO 2. You will need to implement the onPause as it is where the data is saved
    @Override
    protected void onPause() {
        super.onPause();

        //TODO 3. You will need to have a SharedPreferences object
        SharedPreferences.Editor preferencesEditor = mPreferences.edit();

        //TODO 4. You will need to specify the key and the value declared globally
        preferencesEditor.putInt(COUNT_KEY, mCount);
        preferencesEditor.putInt(COLOR_KEY, mColor);

        //TODO 5. Next is that, you need to have .apply() method
        preferencesEditor.apply();
    }
}
